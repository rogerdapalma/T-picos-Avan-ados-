...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        // Exibir a foto do estudante, se disponível
        if (student.getPhoto() != null && !student.getPhoto().isEmpty()) {
            Bitmap studentPhoto = Utils.base64ToBitmap(student.getPhoto());
            holder.imageViewPhoto.setImageBitmap(studentPhoto);
        } else {
            holder.imageViewPhoto.setImageResource(R.drawable.ic_launcher_foreground); // Imagem padrão
        }
    ...
    class StudentViewHolder extends RecyclerView.ViewHolder {
        ...
        public StudentViewHolder(@NonNull View itemView) {
            ...
            imageViewPhoto = itemView.findViewById(R.id.image_view_student_photo);
        }
    }
}